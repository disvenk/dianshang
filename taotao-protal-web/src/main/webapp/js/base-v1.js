 ...
 */
function login() {
    return location.href = "http://localhost:9007/page/login";
}
function regist() {
    return location.href = "http://localhost:9007/page/register";
}
...
function search(a) {
    var b = "http://localhost:9004/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
